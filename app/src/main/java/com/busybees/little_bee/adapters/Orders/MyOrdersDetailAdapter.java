...
import com.busybees.little_bee.activity.OrderDetailActivity;
...
public class MyOrdersDetailAdapter extends RecyclerView.Adapter<MyOrdersDetailAdapter.MyViewHolder> {
    ...
    public MyOrdersDetailAdapter(OrderDetailActivity orderDetailActivity, List<ProductPriceVO> product) {
    ...
    public MyOrdersDetailAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyOrdersDetailAdapter.MyViewHolder holder = new MyOrdersDetailAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(MyOrdersDetailAdapter.MyViewHolder holder, int position) {
