package com.busybees.little_bee.adapters.Receipt;
...
import com.busybees.little_bee.activity.ReceiptDetailActivity;
...
public class ReceiptDetailAdapter extends RecyclerView.Adapter<ReceiptDetailAdapter.MyViewHolder> {
    ...
    public ReceiptDetailAdapter(ReceiptDetailActivity receiptDetailActivity, List<ProductPriceVO> product) {
        this.context=receiptDetailActivity;
        this.list=product;
    }

    @Override
    public ReceiptDetailAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_orders_detail_itemview, parent, false);
        ReceiptDetailAdapter.MyViewHolder holder = new ReceiptDetailAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(ReceiptDetailAdapter.MyViewHolder holder, int position) {
