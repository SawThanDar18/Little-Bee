...
public class LogInActivity extends AppCompatActivity {
    ...
    private void CallGenerateOTP() {
        ...
        obj.setPhone(phoneNumber.getText().toString());
        obj.setOtp(otp);
    ...
    private void CallSendOTP(VerifyObject obj) {
        if (Utility.isOnline(getApplicationContext())) {
            serviceProvider.CallSendOTP(ApiConstants.BASE_URL + ApiConstants.get_send_otp, obj).enqueue(new Callback<VerifyModel>() {
                @Override
    ...
    private void CallSendMessage(VerifyObject obj) {
        ...
        if (Utility.isOnline(getApplicationContext())) {
            serviceProvider.CallSendMessage(url, authorization, sendMessageObject).enqueue(new Callback<SendMessageModel>() {
                @Override
