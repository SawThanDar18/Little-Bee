...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private int ASPECT_RATIO_X = 16, ASPECT_RATIO_Y = 9, bitmapMaxWidth = 1000, bitmapMaxHeight = 1000, IMAGE_COMPRESSION = 80;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent == null) {
            Utility.showToast(getApplicationContext(), getString(R.string.toast_image_intent_null));
            return;
        }
    ...
    private void cropImage(Uri sourceUri) {
        ...
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.theme_color));
